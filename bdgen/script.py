...
SETUP_SYSTEM_PROMPT = dedent("""\
    ...
    1. CHARACTERS — first, for EACH entry in the input `characters` array, copy `id`,
       ...
       body front, and an expressions sheet. The prompt MUST include the global art
       style and the character's full appearance and outfit, and MUST end with
    ...
    2. LOCATIONS — first, for EACH entry in the input `locations` array (which may be
       ...
       text, including the global art style and ending with "No text. No characters."
